...
import com.nhom12.LetsCookApp.adapters.FavoriteFoodAdapter;
...
public class FavoriteFoodActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        loadFavoriteFoods(); // Tải lại danh sách khi quay lại Activity
    }
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                do {
                    ...
                    Log.d("FavoriteFoodActivity", "Food: " + foodName + ", FavoriteCount: " + favoriteCount);
                } while (cursor.moveToNext());
            } else {
                Toast.makeText(this, "Không có món ăn nào trong danh sách yêu thích!", Toast.LENGTH_SHORT).show();
            }
        } catch (Exception e) {
            Log.e("FavoriteFoodActivity", "Lỗi khi tải danh sách: " + e.getMessage());
        } finally {
            if (cursor != null) {
                cursor.close();
            }
