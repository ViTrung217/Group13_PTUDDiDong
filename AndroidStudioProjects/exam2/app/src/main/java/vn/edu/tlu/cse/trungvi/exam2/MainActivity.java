...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etproductId = findViewById(R.id.productId);  // Đảm bảo rằng 'productId' là đúng tên ID từ file XML.
        etproductName = findViewById(R.id.productName);  // Đảm bảo rằng 'productName' là đúng tên ID từ file XML.
        ...
        btnLogout.setOnClickListener(v -> {
            startActivity(new Intent(MainActivity.this, vn.edu.tlu.cse.trungvi.exam.LoginActivity.class));
            finish();
        });
