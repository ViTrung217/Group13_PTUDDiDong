...
public class AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Khởi tạo DatabaseHelper để thao tác với SQLite
    ...
    private void setupRecyclerView() {
        ...
        loadUsers(); // Tải dữ liệu người dùng từ database
    }

    // Tải danh sách người dùng từ database và cập nhật RecyclerView
    ...
    // Hiển thị dialog chi tiết khi nhấn vào một người dùng
    ...
    // Dialog để sửa thông tin người dùng
